...
#   GITHUB_REPO - the github repository name (default: digitags)
#   GITHUB_USER - the github user (default: dockerian)
#   DOCKER_USER - the docker user (default: dockerian)
#   DOCKER_NAME - default: digitags, as in ${DOCKER_USER}/${DOCKER_NAME}
